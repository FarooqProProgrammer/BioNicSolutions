...
export default function Masoinary() {
    return (
        <>
            <div className='MasoneryHeaderBox'>
                <div  className='MasoneryHeaderBoxList'>
                   <h3>Case Studies</h3> 
                   <Box
                    className='MasoneryHeaderBoxListChips'
                   >
                        <div className='Chips px-5 py-2'>
            ...
            <div className='Masonary relative'>
                <div  className='absolute MasonaryCenterLine'>

                </div>
                <article className="flex w-[400px] flex-col dark:bg-gray-900">
                    ...
                    <div className="flex flex-col flex-1 p-6">
                        ...
                        <div className='relative'>
                            <h3 className="flex-1 py-2 text-2xl text-white font-semibold leadi">Te nulla oportere reprimique his dolorum</h3>
                        ...
                        <div className="flex flex-wrap text-white justify-between pt-3 space-x-2 text-xs dark:text-gray-400">
